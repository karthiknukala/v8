...
class DeoptimizationLiteral {
...
#if V8_TARGET_CHERI
  intptr_t GetIntPtr() const {
    DCHECK_EQ(kind_, DeoptimizationLiteralKind::kSignedIntPtr);
    return signed_intptr_;
  }
  uintptr_t GetUintPtr() const {
    DCHECK_EQ(kind_, DeoptimizationLiteralKind::kUnsignedIntPtr);
    return unsigned_intptr_;
  }
#endif
 ...
 private:
  ...
  alignas(sizeof(uintptr_t)) union {
