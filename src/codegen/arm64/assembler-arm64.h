...
class V8_EXPORT_PRIVATE Assembler : public AssemblerBase {
 public:
  ...
  void capmov(const Register& cd, const Register& cn);
...
#if V8_TARGET_CHERI
  static bool IsImmSBUnscaled(uint64_t imm) { return is_uint8(imm); }
 ...
 protected:
  ...
  inline void LoadStoreCapScaledImmOffset(Instr memop, int offset,
                                          unsigned size);
  inline void LoadStoreCapUnscaledImmOffset(Instr memop, int offset);
#endif
