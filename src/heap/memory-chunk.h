...
class V8_EXPORT_PRIVATE MemoryChunk final {
 public:
  ...
  using MainThreadFlags = base::Flags<Flag, ScaledUint>;
  ...
  V8_INLINE bool InYoungGeneration() const {
    ...
    constexpr ScaledUint kYoungGenerationMask = FROM_PAGE | TO_PAGE;
  ...
  V8_INLINE bool IsYoungOrSharedChunk() const {
    constexpr ScaledUint kYoungOrSharedChunkMask =
  ...
  static ScaledInt GetAlignmentForAllocation() { return kAlignment; }
  ...
  // page.
  static constexpr ScaledInt GetAlignmentMaskForAssembler() {
 ...
 private:
  ...
  // declarations.
  static constexpr ScaledInt FlagsOffset() {
    return offsetof(MemoryChunk, untrusted_main_thread_flags_);
  }

  static constexpr ScaledInt kAlignment =
      (static_cast<ScaledUint>(1) << kPageSizeBits);
  static constexpr ScaledInt kAlignmentMask = kAlignment - 1;
...
#error The global metadata pointer table requires a single external code space.
  ...
  static constexpr ScaledInt MetadataIndexOffset() {
  ...
  static constexpr ScaledInt MetadataOffset() {
