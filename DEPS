...
deps = {
  'build':
    Var('chromium_cheri_url') + '/build.git' + '@' + '618acd3e54e17f27c5d786eb6919cc5399b2641d',
  'buildtools':
  ...
  'third_party/ninja': {
    ...
    'dep_type': 'cipd',
    'condition': 'host_cpu != "s390x" and host_os != "zos" and host_cpu != "ppc64" and host_os != freebsd'
  },
  ...
  'third_party/protobuf':
    Var('ctsrd_cheri_url') + '/protobuf.git' + '@' + '8041ee09ee9b8417c2650ce44184b883adb28bbc',
  'third_party/re2/src':
